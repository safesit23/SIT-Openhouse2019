 ...
 * @author jatawatsafe
 */
public class DidYouKnow extends javax.swing.JFrame {
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DidYouKnow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
